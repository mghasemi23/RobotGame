...
public class Red_HorseRobot extends MotherRobot {


    public Red_HorseRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(0);
        Image image = new Image(main.class.getResourceAsStream("file/horse_r.png"), getPixel(), getPixel(), true, true);

...
public class Blue_VerticalRobot extends MotherRobot {

    public Blue_VerticalRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(1);
        Image image = new Image(main.class.getResourceAsStream("file/vertical_b.png"), getPixel(), getPixel(), true, true);

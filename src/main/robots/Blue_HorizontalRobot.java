...
public class Blue_HorizontalRobot extends MotherRobot {


    public Blue_HorizontalRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(1);
        Image image = new Image(main.class.getResourceAsStream("file/horizontal_b.png"), getPixel(), getPixel(), true, true);

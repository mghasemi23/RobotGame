...
public class Blue_HorseRobot extends MotherRobot {

    public Blue_HorseRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(1);
        Image image = new Image(main.class.getResourceAsStream("file/horse_b.png"), getPixel(), getPixel(), true, true);

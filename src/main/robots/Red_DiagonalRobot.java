...
public class Red_DiagonalRobot extends MotherRobot {

    public Red_DiagonalRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(0);
        Image image = new Image(main.class.getResourceAsStream("file/diagonal_r.png"), getPixel(), getPixel(), true, true);

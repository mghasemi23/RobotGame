...
public class Red_HorizontalRobot extends MotherRobot {


    public Red_HorizontalRobot(int attack, int life) {
        super();
        setAttack(attack);
        setLife(life);
        setTeam(0);
        Image image = new Image(main.class.getResourceAsStream("file/horizontal_r.png"), getPixel(), getPixel(), true, true);
